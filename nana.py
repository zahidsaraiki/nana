...
def loginSC():
	...
	if username =="anak" and password =="binjai":
		...
		print"\033[1;96m[!] \033[1;91mZahid!!"
		os.system('xdg-open https://youtu.be/5onPZVfGHjQ')
                time.sleep(1)
                LoginSC()
...
def menu():
	...
	print "\x1b[32;1m2.\x1b[0;1m See list of groups               "
...
def super():
	...
	print logo
	print 42*"\033[1;96m="
	print "\x1b[32;1m1.\x1b[0;1m Crack from the friends list"
	print "\x1b[32;1m2.\x1b[0;1m Crack from friend from friend"
	print "\x1b[32;1m3.\x1b[0;1m Crack from group member"
	print "\x1b[32;1m4.\x1b[0;1m Crack from file"
